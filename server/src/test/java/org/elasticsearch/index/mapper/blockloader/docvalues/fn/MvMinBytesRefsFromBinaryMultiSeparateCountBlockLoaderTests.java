...
public class MvMinBytesRefsFromBinaryMultiSeparateCountBlockLoaderTests extends ESTestCase {
    ...
    public MvMinBytesRefsFromBinaryMultiSeparateCountBlockLoaderTests(boolean blockAtATime, boolean multiValues, boolean missingValues) {
    ...
    public void testMvMin() throws IOException {
        try (Directory dir = newDirectory(); RandomIndexWriter iw = new RandomIndexWriter(random(), dir)) {
            ...
            try (DirectoryReader dr = iw.getReader()) {
                ...
                var mvMinLoader = new MvMinBytesRefsFromBinaryMultiSeparateCountBlockLoader("field");

                var stringsReader = stringsLoader.reader(ctx);
                var mvMinReader = mvMinLoader.reader(ctx);
                assertThat(mvMinReader, hasToString("MvMinBytesRefsFromBinarySeparateCount"));
