...
import org.elasticsearch.action.admin.indices.rollover.TransportRolloverIndexAction;
...
import org.elasticsearch.rest.action.admin.indices.RestRolloverIndexAction2;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(RolloverIndexAction.INSTANCE, TransportRolloverIndexAction.class);
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new RestRolloverIndexAction2(restController));
