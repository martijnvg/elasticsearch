 ...
 * {@link org.elasticsearch.persistent.PersistentTasksClusterService} to update cluster state with the record about running
 * persistent task.
 * <p>
 * 2. The master node updates the {@link org.elasticsearch.persistent.PersistentTasksCustomMetaData} in the cluster state to
 * indicate that there is a new persistent task is running in the system.
 * <p>
 * 3. The {@link org.elasticsearch.persistent.PersistentTasksNodeService} running on every node in the cluster monitors changes
