...
/**
 * Loads the MIN {@code keyword} in each doc for fields with high cardinality.
 */
public class MvMinBytesRefsFromBinaryMultiSeparateCountBlockLoader extends BlockDocValuesReader.DocValuesBlockLoader {

    private final String fieldName;

    public MvMinBytesRefsFromBinaryMultiSeparateCountBlockLoader(String fieldName) {
    ...
    public AllReader reader(LeafReaderContext context) throws IOException {
        ...
        return new MvMinBytesRefsFromBinarySeparateCount(values, counts);
    }

    static class MvMinBytesRefsFromBinarySeparateCount extends BytesRefsFromCustomBinaryBlockLoader.AbstractBytesRefsFromBinary {
        ...
        MvMinBytesRefsFromBinarySeparateCount(BinaryDocValues docValues, NumericDocValues counts) {
            super(docValues);
            this.counts = counts;
        }
        ...
        public void read(int doc, BytesRefBuilder builder) throws IOException {
            ...
            reader.readMin(docValues.binaryValue(), counts.longValue(), builder);
        }

        @Override
        public String toString() {
            return "MvMinBytesRefsFromBinarySeparateCount";
        }
    }
}
