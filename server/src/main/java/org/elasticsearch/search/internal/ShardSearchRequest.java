...
public class ShardSearchRequest extends TransportRequest implements IndicesRequest {
    ...
    public static long computeWaitForCheckpoint(Map<Index, long[]> indexToWaitForCheckpoints, ShardId shardId, int shardRequestIndex) {
        final long[] waitForCheckpoints = indexToWaitForCheckpoints.getOrDefault(shardId.getIndex(), EMPTY_LONG_ARRAY);
