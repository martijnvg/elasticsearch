...
public final class SingletonBinaryDocValuesSyntheticFieldLoaderLayer implements CompositeSyntheticFieldLoader.DocValuesLayer {

    private final String name;
    private SortedBinaryDocValues bytesValues;
    private boolean hasValue;

    public SingletonBinaryDocValuesSyntheticFieldLoaderLayer(String name) {
        this.name = name;
    }
    ...
    public DocValuesLoader docValuesLoader(LeafReader leafReader, int[] docIdsInLeaf) throws IOException {
        ...
        bytesValues = FieldData.singleton(docValues);
