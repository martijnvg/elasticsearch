...
public class TimeSeriesSourceOperatorTests extends AnyOperatorTestCase {
    ...
    TimeSeriesSourceOperatorFactory createTimeSeriesSourceOperator(
        ...
        return TimeSeriesSourceOperatorFactory.create(numDocs, numDocs, 1, TimeValue.ZERO, List.of(ctx), queryFunction);
    }
